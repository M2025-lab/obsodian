...
- [[11.数据库表/所有的starlord数据库表]] — 全库82张表的分层完整目录
- [[11.数据库表/数据库打标签]] — 表的A/B/C/D分类标签
- [[11.数据库表/数据库个人总结]] — 个人接口→数据表映射速查
- [[11.数据库表/starlord全量REST接口与数据表映射]] — REST接口与数据表关联
- [[10.项目整理/业务知识沉淀/edar-starlord系统新人学习文档]] — 核心表对应的业务功能