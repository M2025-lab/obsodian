...
- [[10.项目整理/接口逻辑梳理/主材任务（TaskDispatch）的核心业务逻辑]] — 整体业务逻辑与节点流转
- [[10.项目整理/接口逻辑梳理/主材任务V2激活处理逻辑（MaterialActivateV2ServiceImpl）]] — V2激活前置逻辑
- [[10.项目整理/安装流程]] — 安装任务节点（handleNode的目标节点）
- [[10.项目整理/复尺流程]] — 复尺任务节点（handleNode的目标节点）
